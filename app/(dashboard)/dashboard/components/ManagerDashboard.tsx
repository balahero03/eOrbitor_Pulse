...
export default function ManagerDashboard({ data }: { data: any }) {
  const { stats, teamMembers, leaderboard, pipeline, recentLeads } = data;
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <StatCard label="Team Active Deals" value={stats.teamDeals} color="text-purple-600" href="/pipeline" />
